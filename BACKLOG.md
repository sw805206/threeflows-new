...
| BL-021 | open | style | Footer provisional colors → Claude Design: ratify or revise `--tf-footer-ground` (#4A423C) and footer link (#E68A76); redefine the ground as a computed stone→ink derived tint rather than a hand-picked hex; resolve the #B8ADA5 logo stone-bar contrast on the lighter ground. Recorded in STYLE.md §6. Reconciliation with Claude Design in progress as of this flush | 2026-07-20 | |
